...
if(!isset($_POST['filter_submit'])){
      ...
      if(mysqli_num_rows($sellers_items)==0){$order_list="You have no new orders yet";$income=0;$total_ordered=0;}
                 ...
                 $title="<h4 style='background-color:#D91E18;'>You Have ".$pending_orders." Pending Orders Awaiting Packaging!</h4>";
		      	 ...
		      	 while($orders=mysqli_fetch_assoc($sellers_items)){
				         ...
				         $order_id=$orders['ORDER_ID'];
				      	 ...
				      	 $order_date=date("D d M, Y H:i",strtotime($orders['ORDER_DATE_FULL']));
				      	 $pdt_id=$orders['PT_ID'];;
